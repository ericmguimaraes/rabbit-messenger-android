...
public class LoginActivity extends AppCompatActivity {
    ...
    private void addEmailsToAutoComplete() {
        ...
        emailAddressCollection.add("eric@rabbitmessenger.com.br");
        emailAddressCollection.add("railan@rabbitmessenger.com.br");
        emailAddressCollection.add("tonny@rabbitmessenger.com.br");
